                ...
                <div class="col-md-12">
                    <form action="<?= base_url()."employee/store"?>" method="post">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="emp_job" class="form-control" placeholder="Employee Job">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="emp_address" class="form-control" placeholder="Employee Address">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                <input type="number" name="emp_contact" class="form-control" placeholder="Employee Contact">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                <input type="email" name="emp_email" class="form-control" placeholder="Employee Email">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-2">
